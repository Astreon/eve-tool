...
export type VersionWhereInput = {
  ...
  key?: Prisma.StringFilter<"Version"> | string
  buildNumber?: Prisma.IntFilter<"Version"> | number
  releaseDate?: Prisma.DateTimeFilter<"Version"> | Date | string
}
...
export type VersionScalarWhereWithAggregatesInput = {
  ...
  key?: Prisma.StringWithAggregatesFilter<"Version"> | string
  buildNumber?: Prisma.IntWithAggregatesFilter<"Version"> | number
  releaseDate?: Prisma.DateTimeWithAggregatesFilter<"Version"> | Date | string
}
...
export type VersionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "buildNumber" | "releaseDate", ExtArgs["result"]["version"]>
...
export interface VersionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const versionWithKeyOnly = await prisma.version.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Versions and only return the `key`
   * const versionWithKeyOnly = await prisma.version.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Versions and only return the `key`
   * const versionWithKeyOnly = await prisma.version.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface VersionFieldRefs {
  ...
  readonly buildNumber: Prisma.FieldRef<"Version", 'Int'>
