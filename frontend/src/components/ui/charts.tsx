...
// Wir tippen die Props bewusst "loser", damit Recharts' interne Generics uns nicht zerlegen.
...
type ChartLegendContentOwnProps = {
    hideIcon?: boolean;
    nameKey?: string;
...
function ChartLegendContent(props: ChartLegendContentOwnProps & { [key: string]: any }) {
    const {className, hideIcon = false, payload, verticalAlign = "bottom", nameKey, ...divProps} =
        props;
