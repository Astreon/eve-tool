...
export default function Logo() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width={30} height={30}
            ...
            <path fill="#020617" stroke="url(#b)" strokeWidth="3" d="m0-40 34.6 20v40L0 40l-34.6-20v-40z"
                  transform="translate(64 64)"/>
            <path fill="none" stroke="#0f172a" strokeWidth="2" d="m64 34 26 15v30L64 94 38 79V49z"/>
